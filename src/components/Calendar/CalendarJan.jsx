...
import { HARDCORE_DETAILS_JANUARY } from './CalendarData'
import { COHORT_DATE_RANGE_JANUARY } from './CalendarData'
    ...
    return (
        ...
        <div className={containerClass}>
            <div className='calendar'>
                <h2>Cohort: {COHORT_DATE_RANGE_JANUARY[0].start} - {COHORT_DATE_RANGE_JANUARY[0].end}</h2>
                {HARDCORE_DETAILS_JANUARY.map((classInfo, index) => {
                    return (
