...
export default function CourseSchedule() {
    return (
        <section className='courseSchedule'>
            ...
            <p>Each week for four weeks, we’ll host two live sessions (on Tuesdays and Thursdays at 12pm ET) and two recorded lectures you can watch on your own time or join the live watch parties (on Mondays and Wednesdays at 12pm ET).</p>
            <p>Over the four weeks, Jared will cover eight topics on Outcome-driven UX Metrics. (Yes, eight, you might have attended a UX Metrics Intensive in the past with five topics, we’re now including the three Prepare to Lead sessions in this course.)</p>
