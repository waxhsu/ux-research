        ...
        <section className="testimonials" style={{
            ...
            <div className="testimonials-content">
                <div className="testimonials-test">
                    ...
                    <p>The content of the intensives has deeply impacted my career (and love for experience design). Your framing of UX outcomes and metrics particularly filled a previously daunting gap in my practice. I find myself constantly returning to anecdotes, positions, and points of view that I came across with Jared Spool.</p>
